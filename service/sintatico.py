...
def getTabParsing():
    ...
    tabParsing[55][17] = 23  # <DCLPROC> ::= î
    tabParsing[65][50] = 24  # <DEFPAR> ::= "(" <LID> ":" <TIPO> ";" <LDVAR> ")"
    tabParsing[65][17] = 25  # <DEFPAR> ::= î
